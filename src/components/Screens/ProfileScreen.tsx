...
import { Trophy, Calendar, Star, Settings, Shield, Users, Award, Gift, LogOut, Crown, Search, UserPlus, ArrowLeft, Eye, MessageCircle, UserCheck, Lock, CheckCircle, Ticket, Copy, Check, Package } from 'lucide-react';
      ...
      >
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center space-x-3 mt-2">
              ...
              <div className="flex items-center space-x-1 px-2 py-1 bg-blue-100 rounded-full">
                ...
                <span className="text-xs font-medium text-blue-700">Level {Math.floor((player.accountScore ?? 0) / 500) + 1}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
          ...
          >
            ...
            <p className="text-xl font-bold text-yellow-800">{(player.accountScore ?? 0).toLocaleString()}</p>
          </motion.div>
          <motion.button
          ...
          >
            ...
            <p className="text-xl font-bold text-purple-800">{player.unlockedAchievementsCount || 0}</p>
          </motion.button>
          <motion.button
          ...
          >
            ...
            <p className="text-xl font-bold text-pink-800">{player.collectedCollectiblesCount || 0}</p>
          </motion.button>
        </div>
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Score: {(player.accountScore ?? 0).toLocaleString()}</p>
                  </div>
                </div>
                <motion.button
      ...
      >
        <div className="flex items-center space-x-4 mb-6">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center space-x-3 mt-2">
              ...
              <div className="flex items-center space-x-1 px-2 py-1 bg-blue-100 rounded-full">
                <Star className="w-3 h-3 text-blue-600" />
                <span className="text-xs font-medium text-blue-700">Level {Math.floor((user.accountScore ?? 0) / 500) + 1}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
          ...
          >
            <Star className="w-6 h-6 mx-auto mb-2 text-yellow-600" />
            <p className="text-xs text-yellow-600 font-medium">Pontuação</p>
            <p className="text-xl font-bold text-yellow-800">{(user.accountScore ?? 0).toLocaleString()}</p>
          </motion.div>
          <motion.button
